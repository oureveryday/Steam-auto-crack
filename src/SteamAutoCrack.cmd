...
choice /N /C YN /M "Delete Previous Crack Only File[Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
IF ERRORLEVEL 1 (del /F /S /Q "%~dp0Temp\Crack"  %_null% & rd /S /Q "%~dp0Temp\Crack" %_null% & del /F /S /Q "%~dp0Temp\Crack_Readme.txt" %_null% & echo Deleted. )
)
if EXIST "%~dp0Temp\Crack_Readme.txt" (
choice /N /C YN /M "Delete Previous Crack Only File[Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
IF ERRORLEVEL 1 (del /F /S /Q "%~dp0Temp\Crack"  %_null% & rd /S /Q "%~dp0Temp\Crack" %_null% & del /F /S /Q "%~dp0Temp\Crack_Readme.txt" %_null% & echo Deleted. )
)
if EXIST "%~dp0Temp\Crack.zip" (
choice /N /C YN /M "Delete Previous Crack.zip [Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
...
choice /N /C YN /M "Detected SteamStub Packed .exe. Generate Auto Unpacker (Apply_Crack.cmd) File [Y] / Copy Unpacked .exe [N]:"
...
echo Generating Auto Unpacker......
copy "%~dp0bin\Apply_Crack\Apply_Crack.cmd" "%~dp0TEMP\Crack\Apply_Crack.cmd" /Y %_null%
xcopy "%~dp0bin\Steamless\" "%~dp0TEMP\Crack\Steamless\" /H /E /Y /C /Q /R /I %_null%
echo Generated Auto Unpacker.    
)

:GenCrack3
choice /N /C YN /M "Generate Crack_Readme.txt [Y/N]:"
if /i !errorlevel! EQU 1 (
echo Crack Generated By SteamAutoCrack. > "%~dp0TEMP\Crack_Readme.txt"
echo 1.Copy All File in Crack Folder to Game Folder, then Overwrite. >> "%~dp0TEMP\Crack_Readme.txt"
if NOT defined Apply_Crack echo 2.Run Auto_Crack.bat in Game Folder to Apply Crack. >> "%~dp0TEMP\Crack_Readme.txt"
set Gen_Readme=1
echo Generated Crack_Readme.txt.
)
)

choice /N /C YN /M "Pack Crack Files with .zip archive[Y/N]:"
if /i !errorlevel! EQU 1 (
echo Compressing......
"%~dp0bin\7z\7za.exe" a -tzip "%~dp0TEMP\Crack.zip" "%~dp0TEMP\Crack" %_null%
if !Gen_Readme!==1 ( "%~dp0bin\7z\7za.exe" a -tzip "%~dp0TEMP\Crack.zip" "%~dp0TEMP\Crack_Readme.txt" %_null% )
...
choice /N /C YN /M "Delete Previous steam_settings Folder[Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
...
choice /N /C YN /M "Generate Game Infos online (Default: Yes)[Y/N]:"
IF ERRORLEVEL 2 (
...
IF ERRORLEVEL 1 (
choice /N /C YN /M "Generate Achievement Images (Generate can take longer time. Default: No)[Y/N]:"
...
choice /N /C YN /M "Delete Previous steam_settings\settings Folder[Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
...
echo ---------------------------------------------------
choice /N /C YN /M "Please confirm values[Y/N]:"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
IF ERRORLEVEL 1 (
...
choice /N /C YN /M "This will Auto Update Goldberg Steam Emulator to latest version. Continue[Y/N]?"
IF ERRORLEVEL 2 ( echo Canceled. & pause & goto :Menu )
IF ERRORLEVEL 1 (
mkdir "%~dp0TEMP" %_null%
...
choice /N /C YN /M "Delete TEMP file[Y/N]?"
